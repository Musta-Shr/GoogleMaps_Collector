...
#This a script to look for something in google maps within a certain location
# Then store the results in an excel 


#What do you need for it   (dependencies ??

# Selenium and geckodriver 
# openpyxl 
# standard libraries such as "os " and "time
# 
# 
# "
...
wb.save("comapnies.xlsx")

    
"""
    labels=(entry.text).split("\n")
    for l in labels:
        sub=l.split('·')
        print(sub)
        if len(sub)>1:
            labels[labels.index(l)]=sub[1]
    print (labels)
"""